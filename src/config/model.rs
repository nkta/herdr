...
use super::{
    ActionKeybinds, BindingConfig, CommandKeybindConfig, CommitAgentsConfig, IndexedKeybind,
    Keybinds, SidebarConfig, SoundConfig, TabBarRightEntryConfig, ThemeConfig,
    DEFAULT_MOBILE_WIDTH_THRESHOLD, DEFAULT_MOUSE_SCROLL_LINES, DEFAULT_PREFIX_HINT_DELAY_MS,
...
pub struct Config {
    ...
    pub commit_agents: CommitAgentsConfig,
}
...
pub struct KeysConfig {
    ...
    /// Toggle the sidebar's SPACES/GIT view. Default: "prefix+t"
    pub toggle_sidebar_git_view: BindingConfig,
...
pub(crate) struct KeysConfigOverlay {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    toggle_sidebar_git_view: Option<BindingConfig>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl<'de> Deserialize<'de> for KeysConfig {
        ...
        D: Deserializer<'de>,
    {
        ...
        apply_field!(toggle_sidebar_git_view);
        apply_field!(indexed);
        apply_field!(command);
...
impl KeysConfig {
    ...
    pub(crate) fn local_profile(&self, keybinds: &Keybinds) -> KeysConfigOverlay {
        ...
        copy_effective_action_field!(toggle_sidebar_git_view, keybinds.toggle_sidebar_git_view);
...
impl Default for KeysConfig {
    fn default() -> Self {
        Self {
            ...
            toggle_sidebar_git_view: BindingConfig::one("prefix+t"),
...
"#;
    ...
    #[test]
    fn update_manifest_urls_default_to_the_hosted_ones() {
        let default_config = Config::default();
