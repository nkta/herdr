...
pub(crate) fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::GitPanelSetActive(_) => "git.panel.set_active",
        Method::GitFileStage(_) => "git.file.stage",
        Method::GitFileUnstage(_) => "git.file.unstage",
        Method::GitFileDiscard(_) => "git.file.discard",
        Method::GitCommit(_) => "git.commit",
        Method::GitCommitMessageGenerate(_) => "git.commit_message.generate",
        Method::GitDiffGet(_) => "git.diff.get",
        Method::GitPickerList(_) => "git.picker.list",
        Method::GitRepoFetch(_) => "git.repo.fetch",
        Method::GitRepoPull(_) => "git.repo.pull",
        ...
        Method::CommitAgentList(_) => "commit_agent.list",
        Method::CommitAgentSetActive(_) => "commit_agent.set_active",
